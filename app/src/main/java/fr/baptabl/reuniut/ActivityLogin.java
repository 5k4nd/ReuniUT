...
*/
        login curLogin = fr.baptabl.reuniut.login.getInstance("courbeje", "***");// On cree l'utilisateur
        if (curLogin == null || curLogin.getEmploi() == null)//Si le constructeur a renvoyé une erreur
        {
